...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/09/08 11:51:18 by nolahmar          #+#    #+#             */
/*   Updated: 2023/09/08 11:51:20 by nolahmar         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_redir_list	*parse_here_doc(t_redir_list *redir, char *arg, t_env *env_data);
...
void			execute(t_ast_node *ptr, t_env *env_data, int pipe_input);
...
int				ft_exit(t_cmd *cmd, t_env *env_data);
int				ft_cd(t_cmd *cmd, t_env *env_data);
int				ft_env(t_cmd *cmd, t_env *env_data);
int				ft_echo(t_cmd *cmd, t_env *env_data);

t_elem			*find_env_key(t_elem *head, char *arg, t_env *env_data);
